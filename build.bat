...
echo   "funding_url": "https://github.com/danielfcurrie-alt/weighmybru2",>> "%OUTPUT_DIR%\manifest-supermini.json"
...
echo   "funding_url": "https://github.com/danielfcurrie-alt/weighmybru2",>> "%OUTPUT_DIR%\manifest-xiao.json"
